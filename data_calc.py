...
def handle_file_upload():
    global selected_file, sample_rate, data, spectrum, freqs, t, im
    selected_file = uf.upload_file()
...
def update_high_data():
    global high_data_in_db, index_of_high_max, value_of_high_max, sliced_high_array, value_of_high_max_less_5, \
        index_of_high_max_less_5, value_of_high_max_less_25, index_of_high_max_less_25
...
def update_mid_data():
    global mid_data_in_db, index_of_mid_max, value_of_mid_max, sliced_mid_array, value_of_mid_max_less_5, \
        index_of_mid_max_less_5, value_of_mid_max_less_25, index_of_mid_max_less_25
...
def update_low_data():
    global low_data_in_db, index_of_low_max, value_of_low_max, sliced_low_array, value_of_low_max_less_5, \
        index_of_low_max_less_5, value_of_low_max_less_25, index_of_low_max_less_25
...
def plot_rt60_lmh_data():
    ...
    plt.scatter(t[index_of_high_max_less_5], high_data_in_db[index_of_high_max_less_5],
                color='#00A916', label=f'Max -5: {value_of_high_max_less_5:.2f} dB')
    plt.scatter(t[index_of_high_max_less_25], high_data_in_db[index_of_high_max_less_25],
                color='#00750F', label=f'Max -25: {value_of_high_max_less_25:.2f} dB')
    ...
    plt.scatter(t[index_of_mid_max_less_5], mid_data_in_db[index_of_mid_max_less_5],
                color='#AA7C00', label=f'Max -5: {value_of_mid_max_less_5:.2f} dB')
    plt.scatter(t[index_of_mid_max_less_25], mid_data_in_db[index_of_mid_max_less_25],
                color='#815E00', label=f'Max -25: {value_of_mid_max_less_25:.2f} dB')
    ...
    plt.scatter(t[index_of_low_max_less_5], low_data_in_db[index_of_low_max_less_5],
                color='#A00000', label=f'Max -5: {value_of_low_max_less_5:.2f} dB')
    plt.scatter(t[index_of_low_max_less_25], low_data_in_db[index_of_low_max_less_25],
                color='#800000', label=f'Max -25: {value_of_low_max_less_25:.2f} dB')
...
def rt60_avg():
    rt60 = (rt60_high() + rt60_mid() + rt60_low()) / 3
    return round(abs(rt60), 2)
...
def rt60_diff(rt60):
    difference = rt60 - 0.5
    if difference < 0.5:
        return f"-{round(abs(difference), 2)}"
    elif difference > 0.5:
        return f"+{round(abs(difference), 2)}"
    elif difference == 0.5:
        return f"{round(abs(difference), 2)}"
